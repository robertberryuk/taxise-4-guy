...
#> Task 1 INVASIVE SPECIES: Group data by class and calculate grouped statistics as specified in Guy's email
...
write_csv(data, here("Out", "Data_Processing4Guy_230425", "Bio_Intact_Index_data_for_R", str.folder, paste0("Processed_RB_LONG_", str.var, ".csv")))
...
write_csv(df_wide, here("Out", "Data_Processing4Guy_230425", "Bio_Intact_Index_data_for_R", str.folder, paste0("Processed_RB_WIDE_", str.var, ".csv")))
